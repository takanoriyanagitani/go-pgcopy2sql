...
var typeName util.IO[string] = ArgByIndex(1)
var primitiveName util.IO[string] = ArgByIndex(2)
var defaultValue util.IO[string] = ArgByIndex(3)
...
func (t TypeConfig) PopulateWriteMethod() TypeConfig {
	t.WriteMethodName = "Write" + t.Prefix
	return t
}
